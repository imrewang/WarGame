...
QT_MOC_LITERAL(1, 5, 14), // "killBaseSignal"
QT_MOC_LITERAL(2, 20, 0), // ""
QT_MOC_LITERAL(3, 21, 5), // "Base*"
QT_MOC_LITERAL(4, 27, 14), // "beAttackedSlot"
QT_MOC_LITERAL(5, 42, 12) // "attackPoints"

    },
    "Base\0killBaseSignal\0\0Base*\0beAttackedSlot\0"
    "attackPoints"
};
...
void Base::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->killBaseSignal((*reinterpret_cast< Base*(*)>(_a[1]))); break;
        case 1: _t->beAttackedSlot((*reinterpret_cast< const int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Base::killBaseSignal)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Base::killBaseSignal(Base * _t1)const
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
    QMetaObject::activate(const_cast< Base *>(this), &staticMetaObject, 0, _a);
}
QT_WARNING_POP
