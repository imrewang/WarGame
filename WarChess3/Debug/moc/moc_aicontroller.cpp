...
QT_MOC_LITERAL(1, 13, 15), // "AIRoundFinished"
QT_MOC_LITERAL(2, 29, 0), // ""
QT_MOC_LITERAL(3, 30, 12) // "AIRoundBegin"

    },
    "AIController\0AIRoundFinished\0\0"
    "AIRoundBegin"
};
...
void AIController::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->AIRoundFinished(); break;
        case 1: _t->AIRoundBegin(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (AIController::*)() const;
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&AIController::AIRoundFinished)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (AIController::*)() const;
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&AIController::AIRoundBegin)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void AIController::AIRoundFinished()const
{
    QMetaObject::activate(const_cast< AIController *>(this), &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void AIController::AIRoundBegin()const
{
    QMetaObject::activate(const_cast< AIController *>(this), &staticMetaObject, 1, nullptr);
}
QT_WARNING_POP
