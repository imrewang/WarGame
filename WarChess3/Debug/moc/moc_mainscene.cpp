...
QT_MOC_LITERAL(1, 10, 15), // "deleteGameScene"
QT_MOC_LITERAL(2, 26, 0) // ""

    },
    "MainScene\0deleteGameScene\0"
};
...
void MainScene::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->deleteGameScene(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (MainScene::*)() const;
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MainScene::deleteGameScene)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MainScene::deleteGameScene()const
{
    QMetaObject::activate(const_cast< MainScene *>(this), &staticMetaObject, 0, nullptr);
}
QT_WARNING_POP
